...
export async function getCurrentWeatherById(id) {
    const response = await axios.get(`http://api.openweathermap.org/data/2.5/weather?id=${id}&appid=${API_KEY}&units=metric`)
    return response.data
}